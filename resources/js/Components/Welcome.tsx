...
const Welcome = () => (
  <div>
    <div className="p-6 bg-white border-b border-gray-200 sm:px-20">
      <div>
      ...
      <div className="p-6">
        ...
        <div className="ml-12">
          ...
          <a href="https://laravel.com/docs">
            <div className="flex items-center mt-3 text-sm font-semibold text-indigo-700">
      ...
      <div className="p-6 border-t border-gray-200 md:border-l">
        ...
        <div className="ml-12">
          <div className="mt-2 text-sm text-gray-500">
            ...
            verification and resetting forgotten passwords. So, you&apos;re free to get started what matters most:
